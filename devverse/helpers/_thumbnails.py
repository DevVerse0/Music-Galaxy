...
from devverse.helpers import Track
...
class Thumbnail:
    def __init__(self):
        ...
        self.font1 = ImageFont.truetype("devverse/helpers/Raleway-Bold.ttf", 30)
        self.font2 = ImageFont.truetype("devverse/helpers/Inter-Light.ttf", 30)
    ...
    async def generate(self, song: Track, size=(1280, 720)) -> str:
        try:
            ...
            logger.warning(f"Thumbnail generation failed for {song.id}")
            return None
